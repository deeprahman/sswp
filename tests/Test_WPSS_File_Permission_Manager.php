...
class WPSS_File_Permission_Manager_Test extends TestCase {
    ...
    public function setUp(): void {
        ...
        $this->manager = new WPSS_File_Permission_Manager([
            'test-permissions/test-file.txt',
            'test-permissions/test-config.php',
            'test-permissions/test-directory'
        ]);
    }
    ...
    public function test_get_recommended_permission() {
        ...
        $config_perm = $this->manager->get_recommended_permission($this->test_dir . '/test-config.php');
